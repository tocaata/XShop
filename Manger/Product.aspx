        ...
        <td>
          ...
          <asp:GridView ID="gvGoodsInfo" runat="server" CellPadding="4" Width="100%" HorizontalAlign="Center"
            ...
            <Columns>
              ...
              <asp:BoundField DataField="cat_name" HeaderText="商品名称">
                <ItemStyle HorizontalAlign="Center" />
              </asp:BoundField>
              <asp:TemplateField HeaderText="商品类别">
                ...
                <ItemStyle HorizontalAlign="Center" />
                <ItemTemplate>
                  <%# GetClass(Convert.ToInt32(DataBinder.Eval(Container.DataItem, "category_id").ToString())) %>
                </ItemTemplate>
              </asp:TemplateField>
              <asp:TemplateField HeaderText="商品价格">
                ...
                <ItemStyle HorizontalAlign="Center" />
                <ItemTemplate>
                  <%# GetVarStr(DataBinder.Eval(Container.DataItem, "price").ToString())%>￥
                </ItemTemplate>
              </asp:TemplateField>
